use_racmo_name <- function(racmoVar,
                             originalUnits = TRUE,
                             monthlyData = FALSE,
                             shortName = TRUE) {
  ...
  #'   this.
  #'
  #' @param racmoVar Which RACMO variable to use? Use the short name code.
  ...
  # Names
  fullName <- switch(racmoVar,
                     "precip"   = "Precipitation",
                     "smb"      = "Surface Mass Balance",
                     "sndiv"    = "Snow Drift",
                     "refreeze" = "Snowmelt Refreezing",
